...
class GeneratorFromStrings:
    ...
    def __init__(
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py self.image_dir : {self.image_dir}')
    ...
    def next(self):
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py self.count : {self.count}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py self.strings : {self.strings}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py self.generated_count : {self.generated_count}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py self.fonts : {self.fonts}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py len(self.fonts) : {len(self.fonts)}')

        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!from_strings.py self.fonts[(self.generated_count - 1) % len(self.fonts)] : {self.fonts[(self.generated_count - 1) % len(self.fonts)] }')
