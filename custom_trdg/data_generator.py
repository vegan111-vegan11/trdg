...
class FakeTextDataGenerator(object):
    ...
    def generate(
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!수평 또는 수직으로 텍스트 변환 background_width : {background_width}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!수평 또는 수직으로 텍스트 변환 background_height : {background_height}')
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!data_generator.py 텍스트를 특정 위치에 배치 resized_img.size : {resized_img.size}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!data_generator.py 텍스트를 특정 위치에 배치 new_text_width : {new_text_width}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!data_generator.py 텍스트를 특정 위치에 배치 alignment : {alignment}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!data_generator.py 텍스트를 특정 위치에 배치 width : {width}')
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!data_generator.py 색상 모드 변경  image_mode : {image_mode}')
        #background_img.show()  # 이미지 출력
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!data_generator.py 색상 모드 변경 background_img 이미지 출력 : {background_img}')
        #######################
        # Apply gaussian blur #
        #######################
        # 원본
