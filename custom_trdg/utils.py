...
def mask_to_bboxes(mask: List[Tuple[int, int, int, int]], tess: bool = False):
    ...
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!utils.py bboxes : {bboxes}')
...
def get_text_width(image_font: ImageFont, text: str) -> int:
    ...
    """
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!computer_text_generator.py get_text_width image_font : {image_font}')

    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!computer_text_generator.py get_text_width text : {text}')
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!computer_text_generator.py get_text_width return image_font.getlength(text) : {image_font.getlength(text)}')
...
def get_text_height(image_font: ImageFont, text: str) -> int:
    ...
    print(
        f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!computer_text_generator.py get_text_height return : {image_font.getbbox(text)[3] - image_font.getbbox(text)[1]}')
